...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let claveSeguridad = document.getElementById('claveSeguridad').value;
        ...
        if (btnAbrirConfig) {
            ...
            console.error('❌ Botón configuración NO encontrado');
        }
        ...
        // Cerrar submenús al hacer clic fuera (DESACTIVADO TEMPORALMENTE para debug)
        /*
        document.addEventListener('click', function(e) {
            if (!e.target.closest('.navegacion-lateral')) {
                submenuItems.forEach(item => {
                   if (!item.contains(e.target)) { // Add check to not close if clicking inside
