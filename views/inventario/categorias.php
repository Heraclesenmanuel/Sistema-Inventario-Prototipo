...
<head>
    ...
    <meta name="description" content="Gestión de Categorías - UPEL">
...
<body>
            ...
            <header class="page-header">
                <div class="header-content">
                    ...
                    <div>
                        <h1><?= $titulo ?></h1>
                        <p class="header-date">
                            <i data-lucide="layers" class="date-icon"></i>
            ...
            <section class="config-section">
                ...
                <div class="pagination-controls-top">
                    <div class="entries-selector">
                        ...
                        <span class="entries-label">categorías</span>
                    </div>
                    <div class="pagination-info">
                        <span id="paginationInfo">Mostrando 1 a 10 de 0 categorías</span>
                    </div>
                </div>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" class="no-data">
                                        <i data-lucide="folder-x" class="no-data-icon"></i>
                ...
                <div class="pagination-controls-bottom">
                    <nav class="pagination-nav" aria-label="Paginación de categorías">
                ...
                <div class="modal-content">
                    ...
                    <form id="productForm" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn-submit" id="add" name="add">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const allRows = Array.from(document.querySelectorAll('#categoriasTableBody tr'));
            let currentPage = 1;
            ...
            function updatePagination() {
                ...
                if (totalEntries === 0) {
                    ...
                    paginationInfo.textContent = `Mostrando ${startIndex + 1} a ${endIndex} de ${totalEntries} categorías`;
                }
        ...
        function filtrarProductos() {
            ...
            for (let i = 1; i < filas.length; i++) {
                ...
                let id = filas[i].getElementsByTagName('td')[0];
                let nombre = filas[i].getElementsByTagName('td')[1];
                
                if (id && nombre) {
                    let textoId = id.textContent || id.innerText;
